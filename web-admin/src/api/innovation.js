...
export const getPaymentReminders = (params) => request.get('/payment/reminders', { params })
export const createPaymentReminder = (data) => request.post('/payment-reminder', data)
export const generatePaymentReminders = () => request.post('/payment/reminders/generate')
...
export const getPropertyTasks = (params) => request.get('/tasks', { params })
