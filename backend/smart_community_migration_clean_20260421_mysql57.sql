...
(1, 'openid_owner_001', 'unionid_001', CONCAT('YZ0101101', DATE_FORMAT(NOW(), '%y')), REVERSE(RIGHT(CONCAT('000000', REPLACE(REPLACE(CONCAT('YZ0101101', DATE_FORMAT(NOW(), '%y')), 'YZ', ''), 'XQ', '')), 6)), 1, 1, 'Owner-A', NULL, '13800000001', 1000, 1, NOW() - INTERVAL 40 DAY, NOW() - INTERVAL 40 DAY, 0),
(2, 'openid_owner_002', 'unionid_002', CONCAT('YZ0101102', DATE_FORMAT(NOW(), '%y')), REVERSE(RIGHT(CONCAT('000000', REPLACE(REPLACE(CONCAT('YZ0101102', DATE_FORMAT(NOW(), '%y')), 'YZ', ''), 'XQ', '')), 6)), 1, 1, 'Owner-B', NULL, '13800000002', 500, 1, NOW() - INTERVAL 20 DAY, NOW() - INTERVAL 20 DAY, 0),
(3, 'openid_owner_003', 'unionid_003', CONCAT('YZ0201201', DATE_FORMAT(NOW(), '%y')), REVERSE(RIGHT(CONCAT('000000', REPLACE(REPLACE(CONCAT('YZ0201201', DATE_FORMAT(NOW(), '%y')), 'YZ', ''), 'XQ', '')), 6)), 1, 1, 'Owner-C', NULL, '13800000003', 0, 1, NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 5 DAY, 0),
