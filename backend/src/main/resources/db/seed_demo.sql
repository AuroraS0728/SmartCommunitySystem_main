...
(1, 'openid_owner_001', 'unionid_001', CONCAT('XQYZ', @owner_1), REVERSE(@owner_1), 1, 'Owner-A', NULL, '13800000001', 1, NOW() - INTERVAL 40 DAY, NOW() - INTERVAL 40 DAY, 0),
(2, 'openid_owner_002', 'unionid_002', CONCAT('XQYZ', @owner_2), REVERSE(@owner_2), 1, 'Owner-B', NULL, '13800000002', 1, NOW() - INTERVAL 20 DAY, NOW() - INTERVAL 20 DAY, 0),
(3, 'openid_owner_003', 'unionid_003', CONCAT('XQYZ', @owner_3), REVERSE(@owner_3), 1, 'Owner-C', NULL, '13800000003', 1, NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 5 DAY, 0),
(10, 'openid_admin_001', 'unionid_010', CONCAT('WTGL', @admin_1), REVERSE(@admin_1), 2, 'Admin-A', NULL, '13900000010', 1, NOW() - INTERVAL 100 DAY, NOW() - INTERVAL 100 DAY, 0),
(20, 'openid_worker_001', 'unionid_020', CONCAT('JZWX', @worker_1), REVERSE(@worker_1), 3, 'Worker-A', NULL, '13700000020', 1, NOW() - INTERVAL 80 DAY, NOW() - INTERVAL 80 DAY, 0);
