...
(10, 'openid_admin_001', 'unionid_010', CONCAT('WTGL', @admin_1), REVERSE(@admin_1), 0, 2, 'Admin-A', NULL, '13900000010', 0, 1, NOW() - INTERVAL 100 DAY, NOW() - INTERVAL 100 DAY, 0),
(20, 'openid_worker_001', 'unionid_020', CONCAT('JZWX', @worker_1), REVERSE(@worker_1), 0, 3, 'Worker-A', NULL, '13700000020', 0, 1, NOW() - INTERVAL 80 DAY, NOW() - INTERVAL 80 DAY, 0);
